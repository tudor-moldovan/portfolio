...
// are reachable by subsequent inline scripts in the same document.
  ...
  MODELS.push(
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 5, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 2, reliability: 4, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 4, reliability: 3, tier: 'mainstream',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
  ...
  MODELS.push(
    {
      ...
      euroClass: 'Euro 6d-temp', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 4, reliability: 5, tier: 'mainstream',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 5, tier: 'premium',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6b', lezAccess: 'restricted', ncap: 5, reliability: 4, tier: 'mainstream',
  ...
  MODELS.push(
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 1, reliability: 3, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 4, reliability: 3, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 0, reliability: 3, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 3, tier: 'mainstream',
  ...
  MODELS.push(
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 4, tier: 'premium',
    ...
    },
    {
      ...
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 4, tier: 'mainstream',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 1, reliability: 3, tier: 'premium',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 2, tier: 'luxury',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 3, reliability: 5, tier: 'mainstream',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 4, reliability: 4, tier: 'mainstream',
  ...
  MODELS.push(
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: null, reliability: 4, tier: 'mainstream',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: null, reliability: 4, tier: 'premium',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: null, reliability: 3, tier: 'mainstream',
  ...
  MODELS.push(
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: null, reliability: 5, tier: 'luxury',
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: null, reliability: 5, tier: 'mainstream',
  ...
  MODELS.push(
    ...
    },
    {
      ...
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 4, reliability: 3, tier: 'premium',
  ...
  // ---- Premium fill: small hatches + small sedans ----
  MODELS.push(
    {
      id: 'mini-cooper-f66', archetypes: ['city-petrol-hatch', 'urban-bev'],
      name: 'Mini Cooper (F66 / J01 EV)', years: '2014–present (current gen 2024)', body: 'hatch',
      variants: [
        { name: 'Cooper C 1.5 156hp', fuel: 'petrol', cons: 5.5, co2: 124, hp: 156, gearbox: 'auto' },
        { name: 'Cooper S 2.0 204hp', fuel: 'petrol', cons: 6.0, co2: 137, hp: 204, gearbox: 'auto' },
        { name: 'Cooper E 184hp / SE 218hp', fuel: 'bev', cons: 14.5, co2: 0, hp: 218, gearbox: 'single' },
      ],
      priceUsedEUR: [14000, 32000], priceNewEUR: [29000, 45000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 4, reliability: 3, tier: 'premium',
      strengths: 'Best-handling small premium hatch; cabin design class-leading; EV gen has 400+ km WLTP.',
      weaknesses: 'Run-flat tires firm; BMW dealer parts are not cheap; 1.5 N20 timing chain on early F56.',
    },
    {
      id: 'audi-a1-gb', archetypes: ['city-petrol-hatch'],
      name: 'Audi A1 GB Sportback', years: '2018–2025', body: 'hatch',
      variants: [
        { name: '25 TFSI 95hp', fuel: 'petrol', cons: 5.4, co2: 122, hp: 95, gearbox: 'manual' },
        { name: '30 TFSI 110hp', fuel: 'petrol', cons: 5.6, co2: 127, hp: 110, gearbox: 'manual/dsg' },
        { name: '40 TFSI 200hp DSG', fuel: 'petrol', cons: 6.5, co2: 148, hp: 200, gearbox: 'dsg' },
      ],
      priceUsedEUR: [14000, 26000], priceNewEUR: [25000, 36000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'Premium feel in a B-segment package; same VAG mechanicals as Polo for easier service.',
      weaknesses: 'Discontinued 2025 (no replacement); DSG service mandatory; A1 priced like an A3 used to be.',
    },
    {
      id: 'bmw-1-f40', archetypes: ['city-petrol-hatch', 'compact-petrol-sedan'],
      name: 'BMW 1 Series F40 / F70', years: '2019–present', body: 'hatch',
      variants: [
        { name: '118i 1.5T 136hp MHEV', fuel: 'mhev', cons: 6.0, co2: 137, hp: 136, gearbox: 'auto' },
        { name: '120 2.0T 170hp MHEV', fuel: 'mhev', cons: 6.4, co2: 145, hp: 170, gearbox: 'auto' },
        { name: 'M135i xDrive 300hp', fuel: 'petrol', cons: 7.5, co2: 170, hp: 300, gearbox: 'auto' },
      ],
      priceUsedEUR: [18000, 38000], priceNewEUR: [35000, 55000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'Premium BMW build at hatchback footprint; M135i is a serious AWD hot hatch.',
      weaknesses: 'F40 went FWD (vs old RWD F20) — divisive; B48 timing chain guides on hard-driven units.',
    },
    {
      id: 'mercedes-a-w177', archetypes: ['city-petrol-hatch', 'compact-petrol-sedan'],
      name: 'Mercedes A-Class W177 (hatch + sedan)', years: '2018–present', body: 'hatch',
      variants: [
        { name: 'A 180 / 200 1.3 / 1.4 136 / 163hp', fuel: 'petrol', cons: 5.7, co2: 130, hp: 163, gearbox: 'auto' },
        { name: 'A 180 d / 200 d 116 / 150hp', fuel: 'diesel', cons: 4.5, co2: 118, hp: 150, gearbox: 'auto' },
        { name: 'A 250 e PHEV 218hp', fuel: 'phev', cons: 1.5, co2: 35, hp: 218, gearbox: 'auto' },
      ],
      priceUsedEUR: [16000, 32000], priceNewEUR: [33000, 50000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'MBUX cabin tech is class-leading; PHEV does ~60 km real EV range.',
      weaknesses: '1.3 M282 (jointly developed with Renault) had timing chain issues 2018–20; firm ride.',
    },
    {
      id: 'audi-a3-8y', archetypes: ['compact-petrol-sedan', 'family-combi-petrol'],
      name: 'Audi A3 8Y (Sportback + Sedan)', years: '2020–present', body: 'sedan',
      variants: [
        { name: '30 TFSI 110hp', fuel: 'petrol', cons: 5.4, co2: 122, hp: 110, gearbox: 'manual/dsg' },
        { name: '35 TFSI 150hp', fuel: 'petrol', cons: 5.6, co2: 128, hp: 150, gearbox: 'manual/dsg' },
        { name: '35 TDI 150hp', fuel: 'diesel', cons: 4.7, co2: 124, hp: 150, gearbox: 'manual/dsg' },
        { name: '40 TFSI e PHEV 204hp', fuel: 'phev', cons: 1.4, co2: 32, hp: 204, gearbox: 'dsg' },
      ],
      priceUsedEUR: [22000, 38000], priceNewEUR: [35000, 50000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Premium VAG platform with Audi cabin quality; 35 TDI extremely frugal on motorway.',
      weaknesses: 'DSG service every 60k mandatory; rear seat tighter than VW Golf despite same wheelbase.',
    }
  );

  // ---- Premium fill: family combi (BMW 3T, Audi A4 Avant, MB C Estate, Volvo V60/V90) ----
  MODELS.push(
    {
      id: 'bmw-3t-g21', archetypes: ['family-combi-diesel', 'family-combi-petrol', 'phev-family', 'highway-diesel-sedan', 'mhev-premium'],
      name: 'BMW 3 Series Touring G21', years: '2019–present', body: 'combi',
      variants: [
        { name: '320d 190hp MHEV', fuel: 'diesel', cons: 4.7, co2: 124, hp: 190, gearbox: 'auto' },
        { name: '330d 286hp MHEV B57', fuel: 'diesel', cons: 5.6, co2: 147, hp: 286, gearbox: 'auto' },
        { name: '330e PHEV 292hp', fuel: 'phev', cons: 1.7, co2: 39, hp: 292, gearbox: 'auto' },
        { name: 'M340i xDrive 374hp', fuel: 'mhev', cons: 8.0, co2: 182, hp: 374, gearbox: 'auto' },
      ],
      priceUsedEUR: [25000, 50000], priceNewEUR: [55000, 80000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: '500 L combi boot in a sharp-driving package; B47/B57 diesels are best-in-class refinement.',
      weaknesses: 'Run-flat tires; ZF8 service every 80k non-negotiable; M340i thirsty on motorway.',
    },
    {
      id: 'audi-a4-avant-b9', archetypes: ['family-combi-diesel', 'family-combi-petrol', 'phev-family', 'mhev-premium'],
      name: 'Audi A4 Avant B9 / B9 PA', years: '2015–present', body: 'combi',
      variants: [
        { name: '35 TDI 163hp', fuel: 'diesel', cons: 4.9, co2: 128, hp: 163, gearbox: 'auto' },
        { name: '40 TDI 204hp quattro', fuel: 'diesel', cons: 5.4, co2: 142, hp: 204, gearbox: 'auto' },
        { name: '40 TFSI 204hp MHEV', fuel: 'mhev', cons: 6.5, co2: 148, hp: 204, gearbox: 'auto' },
        { name: '50 TFSI e PHEV 299hp', fuel: 'phev', cons: 1.6, co2: 37, hp: 299, gearbox: 'auto' },
      ],
      priceUsedEUR: [16000, 35000], priceNewEUR: [50000, 72000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: '505 L boot; quattro AWD on diesel; one of the most refined long-distance estates in EU.',
      weaknesses: 'S tronic gearbox pricey to repair; cabin tech feels dated post-2023 vs A6.',
    },
    {
      id: 'mercedes-c-estate-s206', archetypes: ['family-combi-diesel', 'family-combi-petrol', 'phev-family', 'mhev-premium'],
      name: 'Mercedes C-Class Estate S205 / S206', years: '2014–present', body: 'combi',
      variants: [
        { name: 'C 220 d 200hp', fuel: 'diesel', cons: 4.8, co2: 126, hp: 200, gearbox: 'auto' },
        { name: 'C 300 d 4MATIC 269hp', fuel: 'diesel', cons: 5.7, co2: 150, hp: 269, gearbox: 'auto' },
        { name: 'C 300 e PHEV 313hp', fuel: 'phev', cons: 1.4, co2: 32, hp: 313, gearbox: 'auto' },
      ],
      priceUsedEUR: [16000, 38000], priceNewEUR: [55000, 80000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'OM654 diesel meets Euro 6d cleanly; 460 L boot; best long-distance suspension in segment.',
  ...
  // ---- Premium fill: 7-seat SUV / MPV / cargo van ----
  MODELS.push(
    {
      id: 'bmw-x5-g05', archetypes: ['seven-seat-suv', 'mid-suv-diesel', 'mhev-premium', 'phev-family'],
      name: 'BMW X5 G05', years: '2018–present', body: 'suv',
      variants: [
        { name: 'xDrive30d 286hp B57 MHEV', fuel: 'diesel', cons: 6.6, co2: 173, hp: 286, gearbox: 'auto' },
        { name: 'xDrive40d 340hp B57 MHEV', fuel: 'diesel', cons: 7.0, co2: 184, hp: 340, gearbox: 'auto' },
        { name: 'xDrive50e PHEV 489hp', fuel: 'phev', cons: 1.6, co2: 36, hp: 489, gearbox: 'auto' },
      ],
      priceUsedEUR: [40000, 75000], priceNewEUR: [80000, 115000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Optional 7 seats; B57 inline-6 diesel is one of the best in EU; xDrive is genuine AWD.',
      weaknesses: 'Air suspension expensive long-term; xDrive50e PHEV motorway thirst.',
    },
    {
      id: 'bmw-x7-g07', archetypes: ['seven-seat-suv'],
      name: 'BMW X7 G07', years: '2019–present', body: 'suv',
      variants: [
        { name: 'xDrive40d 340hp', fuel: 'diesel', cons: 7.4, co2: 194, hp: 340, gearbox: 'auto' },
        { name: 'M60i xDrive 530hp', fuel: 'mhev', cons: 11.5, co2: 261, hp: 530, gearbox: 'auto' },
      ],
      priceUsedEUR: [60000, 95000], priceNewEUR: [110000, 160000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 0, reliability: 4, tier: 'luxury',
      strengths: 'Genuine 3-row 7-seater with adult-sized 3rd row; B57 diesel makes a 2.5 t car shrink.',
      weaknesses: 'Massive in EU cities; M60i fuel use brutal; styling divides.',
    },
    {
      id: 'mercedes-gle-v167', archetypes: ['seven-seat-suv', 'mid-suv-diesel', 'mhev-premium', 'phev-family'],
      name: 'Mercedes GLE V167', years: '2019–present', body: 'suv',
      variants: [
        { name: 'GLE 300d 4MATIC 269hp MHEV', fuel: 'diesel', cons: 6.8, co2: 178, hp: 269, gearbox: 'auto' },
        { name: 'GLE 450d 4MATIC 367hp MHEV (R6)', fuel: 'diesel', cons: 7.4, co2: 194, hp: 367, gearbox: 'auto' },
        { name: 'GLE 400e PHEV 381hp', fuel: 'phev', cons: 1.4, co2: 31, hp: 381, gearbox: 'auto' },
      ],
      priceUsedEUR: [45000, 80000], priceNewEUR: [85000, 130000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Optional 3rd row; OM656 inline-6 diesel is exceptionally smooth; PHEV does ~100 km real EV.',
      weaknesses: 'Air suspension repair expensive; MBUX climate touch-zone fiddly while driving.',
    },
    {
      id: 'mercedes-gls-x167', archetypes: ['seven-seat-suv'],
      name: 'Mercedes GLS X167', years: '2019–present', body: 'suv',
      variants: [
        { name: 'GLS 450 d 4MATIC 367hp MHEV', fuel: 'diesel', cons: 7.7, co2: 202, hp: 367, gearbox: 'auto' },
        { name: 'GLS 580 4MATIC V8 489hp', fuel: 'mhev', cons: 11.7, co2: 265, hp: 489, gearbox: 'auto' },
      ],
      priceUsedEUR: [60000, 100000], priceNewEUR: [115000, 170000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 0, reliability: 4, tier: 'luxury',
      strengths: 'Most luxurious 7-seater on sale; rear seats heated/cooled with massage; air suspension.',
      weaknesses: 'V8 fuel use absurd; size makes EU underground parking impossible.',
    },
    {
      id: 'audi-q7-4m', archetypes: ['seven-seat-suv', 'mid-suv-diesel', 'phev-family'],
      name: 'Audi Q7 4M', years: '2015–present', body: 'suv',
      variants: [
        { name: '45 TDI quattro 231hp MHEV', fuel: 'diesel', cons: 6.4, co2: 168, hp: 231, gearbox: 'auto' },
        { name: '50 TDI quattro 286hp MHEV', fuel: 'diesel', cons: 6.7, co2: 175, hp: 286, gearbox: 'auto' },
        { name: '55 TFSI e PHEV 381hp', fuel: 'phev', cons: 2.4, co2: 55, hp: 381, gearbox: 'auto' },
      ],
      priceUsedEUR: [25000, 60000], priceNewEUR: [80000, 115000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Quietest 7-seater you can buy; quattro genuinely capable on light off-road.',
      weaknesses: 'Air suspension €€€ at high mileage; SQ7 V8 TDI rare and complex.',
    },
    {
      id: 'volvo-xc90-ii', archetypes: ['seven-seat-suv', 'mid-suv-diesel', 'phev-family'],
      name: 'Volvo XC90 II', years: '2015–present', body: 'suv',
      variants: [
        { name: 'B5 MHEV diesel 235hp AWD', fuel: 'diesel', cons: 6.6, co2: 173, hp: 235, gearbox: 'auto' },
        { name: 'B6 MHEV petrol 300hp AWD', fuel: 'mhev', cons: 8.1, co2: 184, hp: 300, gearbox: 'auto' },
        { name: 'T8 Recharge PHEV 455hp', fuel: 'phev', cons: 1.8, co2: 41, hp: 455, gearbox: 'auto' },
      ],
      priceUsedEUR: [22000, 55000], priceNewEUR: [70000, 95000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Class-leading safety; the 3rd row genuinely fits adults; PHEV does ~50 km real EV.',
      weaknesses: 'D5 diesel dropped 2020 (B5 diesel solid); Sensus laggy pre-Google update.',
    },
    {
      id: 'land-rover-discovery-5', archetypes: ['seven-seat-suv', 'offroad-4x4'],
      name: 'Land Rover Discovery 5 (L462)', years: '2017–present', body: 'suv',
      variants: [
        { name: 'D300 3.0 SD6 MHEV 300hp', fuel: 'diesel', cons: 8.2, co2: 215, hp: 300, gearbox: 'auto' },
        { name: 'P360 3.0 MHEV 360hp', fuel: 'mhev', cons: 9.5, co2: 217, hp: 360, gearbox: 'auto' },
      ],
      priceUsedEUR: [35000, 70000], priceNewEUR: [82000, 120000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 2, tier: 'luxury',
      strengths: '3rd row genuinely usable; serious off-road via terrain response system; tows 3.5 t.',
      weaknesses: 'JLR reliability is the worst in this class; air suspension faults beyond 100k common.',
    },
    {
      id: 'range-rover-sport-l461', archetypes: ['seven-seat-suv', 'offroad-4x4'],
      name: 'Range Rover Sport L461', years: '2022–present', body: 'suv',
      variants: [
        { name: 'D300 3.0 SD6 MHEV 300hp', fuel: 'diesel', cons: 8.0, co2: 211, hp: 300, gearbox: 'auto' },
        { name: 'P440e PHEV 440hp', fuel: 'phev', cons: 1.0, co2: 24, hp: 440, gearbox: 'auto' },
        { name: 'P530 V8 530hp', fuel: 'mhev', cons: 11.6, co2: 264, hp: 530, gearbox: 'auto' },
      ],
      priceUsedEUR: [70000, 120000], priceNewEUR: [110000, 160000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 2, tier: 'luxury',
      strengths: 'Best blend of off-road capability + luxury cabin; PHEV does ~100 km real EV range.',
      weaknesses: 'JLR reliability still a concern (improving on L461); P530 V8 fuel use steep.',
    },
    {
      id: 'mercedes-v-class', archetypes: ['mpv-7seat'],
      name: 'Mercedes V-Class W447 / Marco Polo', years: '2014–present', body: 'mpv',
      variants: [
        { name: 'V 220 d / 250 d / 300 d', fuel: 'diesel', cons: 6.7, co2: 175, hp: 237, gearbox: 'auto' },
        { name: 'EQV 300 90 kWh', fuel: 'bev', cons: 26, co2: 0, hp: 204, gearbox: 'single' },
      ],
      priceUsedEUR: [25000, 65000], priceNewEUR: [70000, 105000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 4, tier: 'premium',
      strengths: 'Limo-grade rear lounge for 6; sliding doors; genuine alternative to a 7-seat SUV.',
      weaknesses: 'Drives like a van (it is one); 7G-Tronic auto can lurch; AdBlue maintenance.',
    },
    {
      id: 'vw-multivan-t7', archetypes: ['mpv-7seat'],
      name: 'VW Multivan T7', years: '2021–present', body: 'mpv',
      variants: [
        { name: '2.0 TDI 150hp DSG', fuel: 'diesel', cons: 6.0, co2: 158, hp: 150, gearbox: 'dsg' },
        { name: '1.4 TSI eHybrid PHEV 218hp', fuel: 'phev', cons: 1.7, co2: 39, hp: 218, gearbox: 'dsg' },
      ],
      priceUsedEUR: [35000, 60000], priceNewEUR: [55000, 85000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'Modular seating with rails; PHEV makes commuting nearly free; better on-road than V-Class.',
      weaknesses: 'Rear seats fixed (no removable benches like classic Caravelle); pricey new.',
    },
    {
      id: 'mercedes-sprinter-907', archetypes: ['cargo-van'],
      name: 'Mercedes Sprinter (W907 / VS30)', years: '2018–present', body: 'van',
      variants: [
        { name: '2.0 CDI 114 / 150 / 170 / 190hp', fuel: 'diesel', cons: 8.5, co2: 223, hp: 190, gearbox: 'manual/auto' },
        { name: 'eSprinter 81 / 113 kWh', fuel: 'bev', cons: 30, co2: 0, hp: 204, gearbox: 'single' },
      ],
      priceUsedEUR: [20000, 50000], priceNewEUR: [42000, 75000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 0, reliability: 4, tier: 'premium',
      strengths: 'Best-built large van in EU; eSprinter has the largest battery in segment (113 kWh).',
      weaknesses: 'Pricier than Ducato/Transit; AdBlue + DPF maintenance non-trivial.',
    }
  );

  // ---- Premium fill: long-range BEV + hybrid SUV + sports/cabrio + off-road ----
  MODELS.push(
    {
      id: 'audi-q4-e-tron', archetypes: ['long-range-bev'],
      name: 'Audi Q4 e-tron / Sportback', years: '2021–present', body: 'crossover',
      variants: [
        { name: '40 e-tron 77 kWh 204hp RWD', fuel: 'bev', cons: 16.7, co2: 0, hp: 204, gearbox: 'single' },
        { name: '50 e-tron quattro 82 kWh 299hp', fuel: 'bev', cons: 17.2, co2: 0, hp: 299, gearbox: 'single' },
        { name: 'SQ4 e-tron 82 kWh 340hp', fuel: 'bev', cons: 18.5, co2: 0, hp: 340, gearbox: 'single' },
      ],
      priceUsedEUR: [32000, 55000], priceNewEUR: [50000, 75000],
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'Same MEB platform as ID.4 but with Audi cabin quality; 50 quattro has real AWD.',
      weaknesses: 'Same MEB software niggles pre-2023; slower DC charge than 800 V Korean rivals.',
    },
    {
      id: 'mercedes-eqe', archetypes: ['long-range-bev', 'mhev-premium'],
      name: 'Mercedes EQE Sedan / SUV', years: '2022–present', body: 'sedan',
      variants: [
        { name: 'EQE 300 89 kWh 245hp', fuel: 'bev', cons: 16.0, co2: 0, hp: 245, gearbox: 'single' },
        { name: 'EQE 350 4MATIC 90 kWh 292hp', fuel: 'bev', cons: 17.0, co2: 0, hp: 292, gearbox: 'single' },
        { name: 'AMG EQE 53 4MATIC+ 626hp', fuel: 'bev', cons: 22.5, co2: 0, hp: 626, gearbox: 'single' },
      ],
      priceUsedEUR: [55000, 95000], priceNewEUR: [80000, 130000],
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 3, tier: 'premium',
      strengths: 'Most aerodynamic production car (Cd 0.20); EQE Sedan does ~530 km real range.',
      weaknesses: 'Hyperscreen distracting; rear visibility poor; depreciation on Mercedes EVs is steep.',
    },
    {
      id: 'porsche-taycan', archetypes: ['long-range-bev', 'sports-coupe'],
      name: 'Porsche Taycan (J1)', years: '2019–present', body: 'sedan',
      variants: [
        { name: 'Taycan RWD 79 / 89 kWh 408 / 435hp', fuel: 'bev', cons: 18.5, co2: 0, hp: 435, gearbox: '2-speed' },
        { name: '4S 79 / 93 kWh 530hp', fuel: 'bev', cons: 19.0, co2: 0, hp: 530, gearbox: '2-speed' },
        { name: 'Turbo S 105 kWh 952hp', fuel: 'bev', cons: 22.0, co2: 0, hp: 952, gearbox: '2-speed' },
      ],
      priceUsedEUR: [55000, 130000], priceNewEUR: [110000, 220000],
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 4, tier: 'luxury',
      strengths: '800 V architecture + 270 kW peak charge — fastest fast-charging EV; drives like a 911.',
      weaknesses: 'Huge price; rear seats tight; range below WLTP (16-19 kWh real-world city, 24+ motorway).',
    },
    {
      id: 'lexus-ux-250h', archetypes: ['compact-crossover-petrol', 'mid-suv-hybrid'],
      name: 'Lexus UX 250h / 300e', years: '2018–present', body: 'crossover',
      variants: [
        { name: '250h 2.0 Hybrid 184hp', fuel: 'hev', cons: 5.4, co2: 122, hp: 184, gearbox: 'cvt' },
        { name: '300e 54 kWh', fuel: 'bev', cons: 17, co2: 0, hp: 204, gearbox: 'single' },
      ],
      priceUsedEUR: [22000, 38000], priceNewEUR: [42000, 55000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 5, reliability: 5, tier: 'premium',
      strengths: 'Toyota hybrid drivetrain in a Lexus body; bulletproof 5-year reliability.',
      weaknesses: 'Tiny boot (320 L); CVT droning; 300e EV range only ~250 km real.',
    },
    {
      id: 'porsche-911-992', archetypes: ['sports-coupe', 'cabrio'],
      name: 'Porsche 911 (992)', years: '2019–present', body: 'coupe',
      variants: [
        { name: 'Carrera 3.0 turbo flat-6 385hp', fuel: 'petrol', cons: 9.6, co2: 218, hp: 385, gearbox: 'pdk' },
        { name: 'Carrera S 4.0 / Carrera 4 GTS 480hp', fuel: 'petrol', cons: 10.5, co2: 238, hp: 480, gearbox: 'pdk' },
        { name: 'Turbo S 3.7 650hp', fuel: 'petrol', cons: 11.1, co2: 254, hp: 650, gearbox: 'pdk' },
      ],
      priceUsedEUR: [85000, 220000], priceNewEUR: [130000, 250000],
      euroClass: 'Euro 6d', lezAccess: 'eu-wide', ncap: 0, reliability: 5, tier: 'luxury',
      strengths: 'Best all-around sports car: usable daily, holds value indefinitely, PDK is sublime.',
      weaknesses: 'Insurance and tires get serious; €15k+ paint-protection wraps for the careful.',
    },
    {
      id: 'jaguar-i-pace', archetypes: ['long-range-bev'],
      name: 'Jaguar I-Pace', years: '2018–2024', body: 'crossover',
      variants: [
        { name: 'EV400 90 kWh AWD 400hp', fuel: 'bev', cons: 21.0, co2: 0, hp: 400, gearbox: 'single' },
      ],
      priceUsedEUR: [22000, 42000], priceNewEUR: null,
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 3, tier: 'luxury',
      strengths: 'Won Car of the Year 2019; great handling for a 2.2 t SUV; gorgeous proportions.',
      weaknesses: 'JLR reliability and software issues; 100 kW peak charge feels slow vs 800 V rivals; discontinued.',
    },
    {
      id: 'audi-q8-e-tron', archetypes: ['long-range-bev', 'seven-seat-suv'],
      name: 'Audi Q8 e-tron / Sportback', years: '2022–present', body: 'suv',
      variants: [
        { name: '50 quattro 95 kWh 340hp', fuel: 'bev', cons: 22.0, co2: 0, hp: 340, gearbox: 'single' },
        { name: '55 quattro 114 kWh 408hp', fuel: 'bev', cons: 22.5, co2: 0, hp: 408, gearbox: 'single' },
        { name: 'SQ8 e-tron 114 kWh 503hp', fuel: 'bev', cons: 24.0, co2: 0, hp: 503, gearbox: 'single' },
      ],
      priceUsedEUR: [50000, 90000], priceNewEUR: [85000, 130000],
      euroClass: 'EV', lezAccess: 'ev', ncap: 5, reliability: 4, tier: 'luxury',
      strengths: 'Most refined large EV cabin; 600 km real range on 114 kWh battery; quattro is genuine.',
      weaknesses: 'Heavy (2.6 t) so consumption is steep; 150 kW DC charge feels modest at this price.',
    }
  );
